...
const Sidebar = (props: any) => {
  ...
  const activeMenu = useMemo(
    (): any => menuItems.find((menu) => menu.link === router.pathname),
    [router.pathname]
  );
  ...
  const getSideItemClasses = (menu: any) => {
    return classNames(
      "flex flex-row items-center transition duration-500 ease-in-out mb-[1px] rounded-lg cursor-pointer hover:bg-primary-hover-blue hover:text-primary-blue",
      {
  ...
  return (
    ...
    <div className={wrapperclassname}>
      <div className="mb-2.5">
        ...
        <div className="lg:mt-2.5 px-4 flex items-center h-[75px] border-b-[1px] border-neutral-white-smoke mb-1 lg:border-0">
            ...
            return (
              <Link href={menu.link} key={menu.id}>
                <div className={classes}>
                  <div className="pr-2.5 pt-[8px] pl-2 pb-2">
                    <Image
                      src={menu.icon}
                      alt={menu.label}
                      className="relative"
